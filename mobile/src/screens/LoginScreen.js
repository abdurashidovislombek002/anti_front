    ...
    >
      <View style={styles.card}>
        <View style={styles.brand}>
          ...
          <Text style={styles.subtitle}>Messenger'ga xush kelibsiz</Text>
        </View>
        ...
        <View style={styles.switchRow}>
          <Text style={styles.switchText}>Hisobingiz yo'qmi? </Text>
          <Pressable onPress={() => navigation.navigate('Register')}>
            <Text style={styles.switchLink}>Ro'yxatdan o'tish</Text>
          </Pressable>
        </View>
      </View>
    </KeyboardAvoidingView>
